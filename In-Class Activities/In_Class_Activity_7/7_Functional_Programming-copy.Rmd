...
for (i in 1:12){
  intro <- paste("On the ", xmas$Day.in.Words[i], "day of Christmas, my true love sent to me")
  total_items <- ""
  for (j in i:1) {
    total_items <- paste(total_items, xmas$phrases[j], sep = ", ")
  }
  print(paste(intro, total_items, sep=""))
}
...
sing_line <- function(song, day){
  intro <- paste("On the ", song$Day.in.Words[day], "day of Christmas, my true love sent to me")
  total_items <- ""
  for (j in day:1) {
